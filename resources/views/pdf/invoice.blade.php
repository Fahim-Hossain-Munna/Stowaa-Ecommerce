                ...
                <table class="align-center" align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:800px;">
                  <tr>
                    <td align="left" height="48" valign="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size:48px; font-weight: 800; line-height: 48px;" class="mobile-center">
                      <h1 style="font-size: 0; line-height: 0; font-weight: 600;  margin: 0; color: #ffffff;"><img src="https://i.ibb.co/dg0M9QL/logo-1x.png" width="200" height="27" style="display: block; border: 0px;" alt="HealthPlanG" /><span>HealthPlan G</span></h1>
                    </td>
                  </tr>
                </table>
              </div>
                      ...
                      <table cellspacing="0" cellpadding="0" border="0" align="right">
                        {{-- <tr>
                          <td style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400;">
                            <p style="font-size: 18px; font-weight: 400; margin: 0; color: #23C467;"><a href="http://healthplang.com/Commerce/Products/" target="_blank" style="color: #23C467; text-decoration-skip: ink;" title="Go to the HealthPlan G Store">Shop HPG</a></p>
                          </td>
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                <tr>
                  <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;">
                    <img src="https://i.ibb.co/XxDng4t/icon-check-mark.png" width="125" height="120" style="display: block; border: 0px;" /><br>
                ...
                <tr>
                  <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 10px;">
                    <p style="font-size: 16px; font-weight: 400; line-height: 24px; color: #777777; padding: 0 30px;">
                        Hi, Sir <span style="font-size: 18px; font-weight: 600; line-height: 24px; color: #ffb703;">{{ $invoice->customer_name }}</span>. Thank you for your recent purchase. We are honored to gain you as a customer and hope to serve you for a long time.
                    </p>
                  </td>
                </tr>
                <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tr>
                        ...
                        <td width="25%" align="left" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 2px solid #eeeeee; border-bottom: 2px solid #eeeeee;">
                          ${{  $invoice->product_round_final_total }}
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                <tr>
                  <td align="center" style="line-height: 0;">
                    <img src="https://i.ibb.co/dg0M9QL/logo-1x.png" width="200" height="27" style="display: block; border: 0px;" />
                  </td>
                </tr>
                <tr>
                  <td align="center" style="color: #ffffff; font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 24px;">
                    <p style="color: #666666; font-size: 14px; font-weight: 600; line-height: 18px; margin-bottom: 0;">
                      Online Platform<br> Cel- +8801755736548
                    </p>
                    <span style="color: #888888; display: block; font-size: 90%; font-weight: 600; padding-top: 15px;">&copy; {{ now()->format('Y') }} {{ env('APP_NAME') }}. All rights reserved.</span>
                  </td>
                </tr>
              </table>
            </td>
