...
<div class="page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Service Edit</a></li>
    </ol>
</div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="basic-form">
                <form action="{{ route('service.update', $service->id) }}" class="mb-3" method="POST">
                   @csrf
                   @method('PATCH')
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <input id="select_icon" type="text" class="form-control" name="service_icon" value="{{ $service->service_icon }}">
