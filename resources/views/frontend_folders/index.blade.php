                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('frontend_assets') }}/assets/images/cart/cart_img_1.jpg" alt="image_not_found">
                            </div>
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('frontend_assets') }}/assets/images/cart/cart_img_2.jpg" alt="image_not_found">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('frontend_assets') }}/assets/images/cart/cart_img_3.jpg" alt="image_not_found">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
                    ...
                    <div class="row">
                        <div class="col-lg-9 offset-lg-3">
                            <div class="main_slider" data-slick='{"arrows": false}'>
                                <div class="slider_item set-bg-image" data-background="{{ asset('frontend_assets') }}/assets/images/slider/slide-2.jpg">
                                ...
                                <div class="slider_item set-bg-image" data-background="{{ asset('frontend_assets') }}/assets/images/slider/slide-3.jpg">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
                                ...
                                <div class="slider_item set-bg-image" data-background="{{ asset('frontend_assets') }}/assets/images/slider/slide-1.jpg">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
                        ...
                        <div class="col-xs-12">
                            <div class="policy-wrap">
                                @forelse ($services as $service)
                                  ...
                                  @endif
                                  @empty
                                  <div class="text-danger">No Policy Detected!!</div>
                                @endforelse
                    ...
                    <div class="row">
                        <div class="col-lg-9 order-lg-3">
                                    ...
                                    @forelse ($products as $product)
                                        <div class="grid">
                                            <div class="product-pic">
                                                ...
                                                @else
                                                   <img src="{{ Avatar::create($product->product_name)->toBase64() }}" width="70" alt='no image found'>
                                                @endif
                            ...
                            <div class="top_category_wrap">
                                ...
                                <div class="top_category_carousel2" data-slick='{"dots": false}'>
                                   @forelse ($categories as $category)
                                     <div class="slider_item">
                                         <div class="category_boxed">
                                             <a href="{{ route('category.grid' , $category->id) }}">
                                                   <span class="item_image">
                                                       <img src="{{ asset('all_images/category_pictures') }}/{{ $category->category_photo }}" alt="image_not_found">
                                                   </span>
                                   ...
                                   @empty
                                   <div class="text-danger">No Categories Detected!!</div>
                                   @endforelse
                        ...
                        <div class="col-lg-3 order-lg-9">
                            <div class="product-sidebar">
                                <div class="widget latest_product_carousel">
                                    ...
                                    <div class="vertical_slider_4item" data-slick='{"dots": false}'>
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{ asset('frontend_assets') }}/assets/images/latest_product/latest_product_1.png" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                        ...
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{ asset('frontend_assets') }}/assets/images/latest_product/latest_product_2.png" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                                        <a href="shop_details.html">Product Sample</a>
                                        ...
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{ asset('frontend_assets') }}/assets/images/latest_product/latest_product_3.png" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                                        <a href="shop_details.html">Product Sample</a>
                                        ...
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{ asset('frontend_assets') }}/assets/images/latest_product/latest_product_4.png" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                                        <a href="shop_details.html">Product Sample</a>
                                ...
                                <div class="widget audio-widget" style="margin-top: 200px;">
                    ...
                    <div class="row newarrivals_products">
                        ...
                        <div class="col col-lg-7">
                            <div class="new-arrivals-grids clearfix">
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/shop/product-img-28.png" alt>
                                    </div>
                                    <div class="details">
                                ...
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/shop/product-img-26.png" alt>
                                ...
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/shop/product-img-27.png" alt>
                                ...
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/shop/product_img_12.png" alt>
                ...
                <div class="container">
                    ...
                    <div class="brand_carousel">
                        @forelse ($sponsors as $sponsor)
                            @if ($sponsor->status == 1)
                                <div class="slider_item">
                                    <a class="product_brand_logo" href="#!">
                                        <img src="{{ asset('all_images/sponsors_images') }}/{{ $sponsor->sponsor_photo }}" alt="image_not_found">
                                        <img src="{{ asset('all_images/sponsors_images') }}/{{ $sponsor->sponsor_photo }}" alt="image_not_found">
                                    </a>
                                </div>
                            ...
                            @empty
                            <div class="slider_item">
                                <span class="product_brand_logo text-danger">
                                     No Sponsor/Brand Image Detected!!
                        ...
                        <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/viewed_products/viewed_product_img_1.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/viewed_products/viewed_product_img_2.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                            ...
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/viewed_products/viewed_product_img_3.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/viewed_products/viewed_product_img_4.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                            ...
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/viewed_products/viewed_product_img_5.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/viewed_products/viewed_product_img_6.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
