                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="register_wrap tab-content">
                                ...
                                <div class="tab-pane fade show active" id="signup_tab" role="tabpanel">
                                    @if (session('customer_registration_success_msg'))
                                        <div class="alert alert-success">
                                           {{session('customer_registration_success_msg')}}
                                        </div>
                                    @endif
                                    ...
                                    <form action="{{ route('login.insert') }}" method="POST">
                                        ...
                                        <div class="form_item_wrap">
                                            ...
                                            <div class="form_item">
                                                ...
                                                <input class="@error('password') is-invalid @enderror" id="password_input2" type="password" name="password" placeholder="type Password" value="{{ old('password') }}">
                                                @error('password')
                                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form_item_wrap">
                                            ...
                                            <div class="form_item">
                                                <label for="password_input2"><i class="fas fa-lock"></i></label>
                                                <input class="@error('title') is-invalid @enderror" id="password_input2" type="password" name="password_confirmation" placeholder="type confirm Password">
                                            </div>
                                        </div>
