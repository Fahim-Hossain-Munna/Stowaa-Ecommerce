...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/bootstrap.min.css">

    <!-- icon font - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/fontawesome.css">
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">


    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&family=Roboto:wght@100;300;400;500;700;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/stroke-gap-icons.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/icofont.css">

    <!-- animation - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/animate.css">

    <!-- carousel - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/slick.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/slick-theme.css">

    <!-- popup - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/magnific-popup.css">

    <!-- jquery-ui - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/jquery-ui.css">

    <!-- select option - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/nice-select.css">

    <!-- woocommercen - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/woocommerce.css">

    <!-- custom - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/assets/css/style.css">
    @livewireStyles
</head>
...
<body>
            ...
            <div class="header_top">
                <div class="container">
                    <div class="row align-items-center">
                            ...
                            <ul class="header_select_options ul_li">
                                <li>
                                    <div class="select_option">
                                        <div class="flug_wrap">
                                            <img src="{{ asset('frontend_assets') }}/assets/images/flug/flug_uk.png" alt="image_not_found">
                                        </div>
                                        <select>
                        ...
                        <div class="col col-md-6">
                            <a href="{{ route('vendor.registration') }}" class="header_hotline">Vendor/Shop Owner : <strong>login/registration</strong></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="{{ asset('frontend_assets') }}/assets/images/logo/logo_1x.png" srcset="{{ asset('frontend_assets') }}/assets/images/logo/logo_2x.png 2x" alt>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="{{ asset('frontend_assets') }}/assets/images/logo/logo_1x.png" srcset="{{ asset('frontend_assets') }}/assets/images/logo/logo_2x.png 2x" alt="logo_not_found">
                                    </a>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    <li><a href="#!"><img src="{{ asset('frontend_assets') }}/assets/images/app_store.png" alt="app_store"></a></li>
                                    <li><a href="#!"><img src="{{ asset('frontend_assets') }}/assets/images/play_store.png" alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <div class="payment_method">
                                <h4>Payment:</h4>
                                <img src="{{ asset('frontend_assets') }}/assets/images/payments_icon.png" alt="image_not_found">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset('frontend_assets') }}/assets/js/jquery-plugins-collection.js"></script>

    <!-- google map  -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
    <script src="{{ asset('frontend_assets') }}/assets/js/gmaps.min.js"></script>
