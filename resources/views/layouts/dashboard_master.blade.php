    ...
    ***********************************-->
    <div id="main-wrapper">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    <img src="{{ asset('profile_uploaded_image') }}/{{ auth()->user()->photo_update }}" alt="" width="20" class="img-fluid rounded-circle">
                                    @else
                                    <img src="{{ asset('dashboard_assets') }}/profile_image/default_image.png" width="20" alt=""/>
                                    @endif
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							@if (auth()->user()->role != 'vendor')
                                <li><a href="{{ route('users') }}">User Lists</a></li>
                            @endif
                    ...
                    <li><a target="_blank" href="{{ url('/') }}" aria-expanded="false">
            ...
            <ul aria-expanded="false">
                ...
                <li><a href="{{ route('service.create') }}">Services Add</a></li>
        ...
        <ul aria-expanded="false">
            <li><a href="{{ route('sponsor.index') }}">Sponsors List</a></li>
            <li><a href="{{ route('sponsor.create') }}">Sponsors Add</a></li>

        </ul>
       </li>
       <li><a class="has-arrow ai-icon"  aria-expanded="false">
        <i class="material-symbols-outlined"> mark_chat_read </i>
        <span class="nav-text">Client Masages</span>
        </a>
        <ul aria-expanded="false">
            <li><a href="{{ route('client-massage.index') }}">Masages List</a></li>
            ...
            <ul aria-expanded="false">
				...
				<div class="copyright">
					...
					<p>Made with <span class="heart"></span> by Fahim Hossain</p>
				</div>
			</div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://dexignzone.com/" target="_blank">Fahim Hossain</a> {{ \Carbon\Carbon::now()->format('Y') }}</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <script>
        $(document).ready(function(){
            $('.icon_pick').click(function(){
                $('#select_icon').val($(this).attr('id'));
            });
        });
